...
class EditarProfessorScreen extends StatefulWidget {
  EditarProfessorScreen({Key key}) : super(key: key);

  @override
  _EditarProfessorScreenState createState() => _EditarProfessorScreenState();
}

class _EditarProfessorScreenState extends State<EditarProfessorScreen> {
